    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 h-full flex flex-col hover:shadow-md transition-shadow duration-300">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900 tracking-tight">{t("效益")}</h2>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-5 flex-1 flex flex-col">
        ...
        <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-100">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-2">
            <Wallet size={12} /> {t("昨日表现")}
          </h3>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="text-xs text-slate-500 mb-1">{t("昨日总收益")}</div>
            ...
            <div>
              <div className="text-xs text-slate-500 mb-1">{t("昨日产出效率")}</div>
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-3 mb-2">
            ...
            <div className="flex justify-between items-center py-1.5 border-b border-slate-50">
              <span className="text-sm text-slate-500">
                {t("{{value}}月托管占比", { value: lastProfitStatus?.month })}
              </span>
        ...
        <div className="pt-2 border-t border-slate-50">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-2">
            <PieChart size={12} /> {t("托管费占比详情")}
          </h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center group">
              <span className="text-xs text-slate-500">{t("昨日平均")}</span>
              <div className="flex items-center gap-3">
            ...
            <div className="flex justify-between items-center group">
              <span className="text-xs text-slate-500">{t("昨日最高")}</span>
              <div className="flex items-center gap-3">
                <div className="w-24 md:w-32 h-2 bg-slate-100 rounded-full overflow-hidden">
                  <div
            ...
            <div className="flex justify-between items-center group">
              <span className="text-xs text-slate-500 truncate mr-2" title={t("最高场地14天平均")}>
                {t("最高场地14天平均")}
              </span>
              <div className="flex items-center gap-3">
                <div className="w-24 md:w-32 h-2 bg-slate-100 rounded-full overflow-hidden">
