...
export const UTILITY_TOOLS: UtilityTool[] = [
  {
    id: "asset-management",
    name: t("资产管理系统"),
    description: t("全面管理矿机资产，包括入库、分配、状态监控及资产盘点。"),
...

  {
    id: "hashprice",
    name: t("Hashprice 指数"),
    description: t("追踪比特币挖矿单位算力的实时价值 (USD/TH/day)，掌握核心收益指标。"),
    // icon: hashrate,
  ...
  },
  {
    ...
    name: t("全网难度趋势"),
    description: t("预测下一次挖矿难度调整的时间与幅度，辅助运营决策。"),
  ...
  },
  {
    id: "maintenance",
    name: t("维修管理系统"),
    description: t("记录矿机故障、维修进度及备件消耗，提升设备在线率。"),
  ...
  {
    id: "btc-explorer",
    name: t("Cloverpool 浏览器"),
    description: t("专业、快速的比特币区块浏览器，实时监控区块生成与交易确认情况。"),
  ...
  {
    id: "cryptopanic",
    name: t("CryptoPanic 资讯"),
    description: t("实时聚合全球加密货币行业新闻，掌握影响币价与难度的宏观动态。"),
  ...
  },
  {
    ...
    name: t("挖矿收益计算器"),
    description: t("基于实时全网难度与币价，快速计算不同型号矿机的每日预估收益。"),
